...
import com.mangoreader.network.response.BookListResponseBycategory.Book.Info;

import android.util.Log;


public class BookListResponseBycategory {
	...
	public BookListResponseBycategory(byte[] data) throws JSONException {
		...
		for( int i = 0 ; i < books.length; i++){
			...
			book.price = jObject.getDouble("price");
