...
import com.mangoreader.network.response.BookListResponseByAge.Book.Info;

import android.util.Log;


public class BookListResponseByAge {
	...
	public BookListResponseByAge(byte[] data) throws JSONException {
