...
/*
	...
	public StoryPageScreen(ScreenAdapter screenAdapter, Page model) {
	...
	private void draw(float delta) {
		...
		if (storyText!=null) {
			...
			font.drawMultiLine(batcher, insertNewlineChars(storyText,textBoxDimen.x,font), textDimen.x,textDimen.y/*Utils.textpositionleft().x, Utils.textpositionleft().y*/);
